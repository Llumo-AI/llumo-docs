...
[Customize Evaluation](https://docs.llumo.ai/how-to-docs/evaluate-llms/customize-evaluations)

[Setup Prompt Evaluation API  ](https://docs.llumo.ai/setup-llumo/setup-evaluation/api)

[Create Custom Evaluation ](https://docs.llumo.ai/how-to-docs/evaluate-llms/create-custom-evals)

[Evaluate a Bulk Dataset Using 3–4 Metrics ](https://docs.llumo.ai/llm-evaluation/how-to-docs/evaluate-dataset-multiple-metric)

[Run Evaluation in Production ](https://docs.llumo.ai/llm-evaluation/how-to-docs/run-eval-prod)
