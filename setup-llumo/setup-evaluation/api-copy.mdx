...
<AccordionGroup>
  <Accordion icon="arrow-pointer" title="Select Evaluation journey">
    ...
    ![Evaluation Journey Selection](https://storage.googleapis.com/llumo-blog-images-1/LLUMO-Cover-image.png))
  ...
  <Accordion icon="bars" title="Navigate to Evaluation and open setup modal">
    ...
    ![insert video zooming in from whole screen to left nav and then click mouse pointer selecting in to compressor](https://storage.googleapis.com/llumo-blog-images-1/LLUMO-Cover-image.png))

    Then you can see a banner on the top of the page, asking you to set up. Click on “Setup Now”

![banner with mouse pointer clicking CTA](https://storage.googleapis.com/llumo-blog-images-1/LLUMO-Cover-image.png))
